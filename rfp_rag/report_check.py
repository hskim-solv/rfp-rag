...
def check_report(eval_dir: Path | str, readme: Path | str) -> dict[str, Any]:
    """Validate the current offline-contract evidence only.

    Real-lane eval dirs are out of scope and are flagged as
    ...
    # README must also document the current real provider quality lane section.
    required_readme = (
