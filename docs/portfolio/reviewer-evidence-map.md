...
| Hosted reviewer demo | HTTPS URL, reviewer-token boundary, rate-limit boundary, public-safe source boundary, redacted hosted ops | `hosted_demo_smoke_complete=true`, `rate_limit_boundary_pass=1.0`, `hosted_deployment_evidence_complete=true`, `secret_leak_count=0`, `raw_rfp_text_seen=0` |
